...
static ssize_t procfile_read_1(struct file *file_pointer, char __user *buffer,
...
static ssize_t procfile_read_2(struct file *file_pointer, char __user *buffer,
                               size_t buffer_length, loff_t *offset) {
